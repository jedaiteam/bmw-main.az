 ...
 window.addEventListener('scroll',handleScroll);
  ...
  return (
    ...
    <div className={styles.fullBody}>
      ...
      <Head>
        <title>BMW işlənmiş ehtiyat hissələri satış. bmwpartsbaku bmw hisse</title>
        <meta name="description" content="BMW işlənmiş ehtiyat hissələrinin satışı. Ən keyfiyyətli bmw hisseleri. Bmw ehtiyat hisseleri qiymetleri. Bmwpartsbaku.az. Bakıda original BMW hisseleri almaq " />
        <link rel="icon" href="../uploads/bmw.svg" />
        <link rel="canonical" href="https://bmwpartsbaku.az" /> 
        <meta name="keywords" content="bmw ehtiyat hisseleri, bmw işlənmiş ehtiyat hissələri, bmw hisse"/>
...
<div className={styles.LinkHome}>
    ...
    <ul style={{width:"100%",display:'flex',flexDirection:"column",alignItems:"center",marginBottom:"50px",marginTop:"50px"}}>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>BMW avtomobiliniz sizi hər gün təsir edici performansla sevindirməyə hazırdır. BMW ehtiyat hissələrinin bir -birinə mükəmməl nisbəti avtomobilin maksimum performansını təmin edir. Bu səbəbdən həmişə Orijinal BMW işlənmiş ehtiyat hissələri seçməyinizi tövsiyə edirik: Maksimum performans yalnız avtomobil hissələri müəyyən xüsusiyyətlərə tam uyğun gəldikdə əldə edilə bilər.  </>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Eyni ciddi istehsal standartları, BMW avtomobillərinə tətbiq edildiyi kimi, Orijinal işlənmiş BMW hissələri üçün də tətbiq olunur - dizayndan keyfiyyətə nəzarətə qədər. Hər original BMW ehtiyat  hissəsindəki dəqiqlik və yüksək keyfiyyətli iş, avtomobilinizin bütün komponentlərinin bir -biri ilə mükəmməl bir şəkildə işləməsini təmin edərək, optimal dinamikanı, ən yüksək təhlükəsizlik və etibarlılığı təmin edir. </>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>bmwpartsbaku.az olaraq sizə ən keyfiyyətli BMW işlənmiş ehtiyat hissələri təklif edirik. Onlayn mağazamızın kataloqunda BMW avtomobiliniz üçün geniş çeşiddə və münasib qiymətə təqdim olunan BMW işlənmiş ehtiyat hissələri əldə edə bilərsiniz.  </>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Satış qrupumuz, maşınınız üçün ən uyğun aksesuarların seçilməsində sizə kömək etməyə hazırdır. Və əgər indi Bakıda BMW üçün ucuz avtomobil hissələri almağı planlaşdırırsınızsa, burada sizə lazım olan hər şeyi tapa bilərsiniz.  </>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Mağazamızın çeşidinə əfsanəvi Alman markasının avtomobili üçün ən yaxşı  BMW hissələri, komponentləri daxildir. Buna görə də hər bir məhsul vahidinin keyfiyyətinə, orijinallığına görə müştərilərimiz qarşısında məsuliyyət daşıyırıq. </>

...
<div className={styles.LinkHome}>
    ...
    <ul style={{width:"100%",display:'flex',flexDirection:"column",alignItems:"center",marginBottom:"50px",marginTop:"50px",rowGap:"15px"}}>
        ...
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Satış qrupumuz, maşınınız üçün ən uyğun aksesuarların seçilməsində sizə kömək etməyə hazırdır. Və əgər indi Bakıda BMW üçün ucuz avtomobil hissələri almağı planlaşdırırsınızsa, burada sizə lazım olan hər şeyi tapa bilərsiniz.  </li>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Mağazamızın çeşidinə əfsanəvi Alman markasının avtomobili üçün ən yaxşı  BMW hissələri, komponentləri daxildir. Buna görə də hər bir məhsul vahidinin keyfiyyətinə, orijinallığına görə müştərilərimiz qarşısında məsuliyyət daşıyırıq. </li>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify"}}>Avtomobiliniz üçün ən keyfiyyətli BMW ehtiyat hissələri və avadanlıqlar almalısınız. Bölmənin performansı birbaşa hər cür hissələrdən, istehlak materiallarından, komponentlərdən asılıdır. Köhnəlmiş hissələrin dəyişdirilməsi təkcə avtomobilin mükəmməl xidmətinin deyil, həm də yolda təhlükəsizliyinizin təminatıdır. </li>
        <li style={{width:"80%", fontSize:"23px", textAlign:"justify", marginBottom:"50px"}}>Avtomobilin xidmət qabiliyyətinə və öz rifahına diqqət yetirən ciddi motoristlər BMW işlənmiş ehtiyat hissələrini Bakıda yalnız orijinal komponentləri olan sübut edilmiş pərakəndə satış yerlərində alırlar. Bu yerlərdən biri də onlayn mağazamızdır. </li>
    </ul>
